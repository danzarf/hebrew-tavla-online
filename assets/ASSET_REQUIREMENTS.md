...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Dice roll | `assets/sounds/dice-roll-1.mp3`, `assets/sounds/dice-roll-2.mp3`, `assets/sounds/dice-roll-3.mp3`; `assets/sounds/dice-roll.mp3` is the fallback file | MP3, 44.1 kHz or 48 kHz, stereo or mono | 150 KB each | 0.6–1.2 sec | Quiet/medium-low; no sharp peaks | Dice roll starts and normal roll reveal finishes; one variant is selected randomly per play | Generated `roll` tone |
