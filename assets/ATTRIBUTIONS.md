...
| `assets/sounds/dice-roll-1.mp3` | https://freesound.org/s/538960/ by VM83 | Attribution / CC BY | Yes | Trimmed from the original three-throw audio to keep only the clean dice landing/roll impact; small fade in/out and volume normalization applied. |
| `assets/sounds/dice-roll-2.mp3` | https://freesound.org/s/538960/ by VM83 | Attribution / CC BY | Yes | Trimmed from the original three-throw audio to keep only the clean dice landing/roll impact; small fade in/out and volume normalization applied. |
| `assets/sounds/dice-roll-3.mp3` | https://freesound.org/s/538960/ by VM83 | Attribution / CC BY | Yes | Trimmed from the original three-throw audio to keep only the clean dice landing/roll impact; small fade in/out and volume normalization applied. |
| `assets/sounds/dice-roll.mp3` | https://freesound.org/s/538960/ by VM83 | Attribution / CC BY | Yes | Fallback dice-roll file; trimmed from the original three-throw audio to keep only the clean dice landing/roll impact; small fade in/out and volume normalization applied. |
